 ...
 * @author Abner
 */
public class SystemDefaultSettingValue implements Serializable{
    ...
    public SystemDefaultSettingValue()
    {
        id = 0;
    ...
    /**
     * @param defaultSettingId the defaultSettingId to set
     */
