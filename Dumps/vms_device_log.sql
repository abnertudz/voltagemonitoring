...
CREATE TABLE `device_log` (
  `device_log_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `device_log_date_created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `device_log_last_modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `device_log_date_started` datetime DEFAULT NULL,
  `device_log_date_stopped` datetime DEFAULT NULL,
...
-- Dump completed on 2013-07-12 13:26:20
